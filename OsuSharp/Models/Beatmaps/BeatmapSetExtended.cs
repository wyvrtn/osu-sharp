...
public class BeatmapSetExtended : BeatmapSet
{
    ...
    public bool CanBeHyped { get; private set; } = default!;
    ...
    public bool IsDiscussionLocked { get; private set; } = default!;
    ...
    public string? LegacyThreadUrl { get; private set; } = default!;
    ...
    public DateTimeOffset? RankedDate { get; private set; } = default!;

    /// <summary>
    /// Bool whether this beatmapset has a storyboard.
    /// </summary>
    [JsonProperty("storyboard")]
    public bool HasStoryboard { get; private set; } = default!;

    /// <summary>
    /// The datetime at which this beatmapset was submitted to the osu! servers.
    /// </summary>
    [JsonProperty("submitted_date")]
    public DateTimeOffset? SubmittedDate { get; private set; } = default!;
